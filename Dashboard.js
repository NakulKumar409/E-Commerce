...
const CustomLineChart = ({ data }) => {
  const maxValue = Math.max(
    ...data.map((d) => Math.max(d.invited, d.completed))
  );
    ...
    return data
      .map((item, index) => {
        ...
        const y =
          chartHeight -
          padding -
          (item[dataKey] / maxValue) * (chartHeight - 2 * padding);
        return `${x},${y}`;
      })
      .join(" ");
  };
      ...
      <svg
        ...
        {data.map((item, index) => {
          ...
          const invitedY =
            chartHeight -
            padding -
            (item.invited / maxValue) * (chartHeight - 2 * padding);
          const completedY =
            chartHeight -
            padding -
            (item.completed / maxValue) * (chartHeight - 2 * padding);
  ...
  return (
    <div className="flex flex-col items-center">
      <svg
        ...
        {data.map((item, index) => {
          const barHeight =
            (item.value / maxValue) * (chartHeight - 2 * padding);
...
const Dashboard = () => {
  ...
  const analyticsData = {
    ...
    internalExternalData: [
      { name: "External", value: 220 },
      { name: "Internal", value: 120 },
    ],
    priorityFeatures: [
      {
        feature: "Code Review",
  ...
  const StatCard = ({
    ...
    <div className={`${bgColor} rounded-xl shadow-sm border-0 p-6 hover:shadow-md transition-shadow`}>
      ...
      <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search for Existing Test, Candidate Name, Results"
                  className="pl-10 pr-4 py-2 w-96 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                />
              </div>
            </div>
        ...
        <main className="flex-1 overflow-auto bg-gray-50 p-6">
          ...
          <div className="space-y-6">
            ...
            {/* Charts Section - Three Charts in a Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                ...
                <CustomBarChart data={analyticsData.internalExternalData} />
              </div>
            </div>
